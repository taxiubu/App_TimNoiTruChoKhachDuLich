...
public class SQLHistoryItem extends SQLiteOpenHelper {
    private static final String TAG = "SQLHistoryItem";
    static final String DB_NAME_TABLE = "SQLHistoryItem";
    static final String DB_NAME= "SQLHistoryItem.db";
    static final int VERSION= 1;
    SQLiteDatabase sqLiteDatabase;
    ContentValues contentValues;
    Cursor cursor;
    public SQLHistoryItem(Context context) {
        super(context, DB_NAME, null, VERSION);
    }

    @Override
    public void onCreate(SQLiteDatabase db) {
        String SQLHistoryItem = "CREATE TABLE SQLHistoryItem ( "+
                "name TEXT," +
                "type TEXT," +
                "address TEXT," +
                "price TEXT," +
